    ...
    <div className='bg-[#f7f5f4] w-full h-screen flex justify-center items-center sm:flex-col sm:max-w-2xl sm:mx-auto sm:h-min rounded-md px-2 py-4'>
      ...
      <div className='bg-white rounded-2xl max-w-96 w-full sm:mx-auto grow p-4 my-4'>
        ...
        <form className='py-2' action="">
          ...
          <TextInput icon={<EmailSVG className={'stroke-zinc-600 stroke-[1.5px]'}/>} placeholder={'Your Email'} ref={inputRef} />
          <TextInput icon={<LockSVG className={'stroke-zinc-600 stroke-[1.5px]'}/>} placeholder={'Your Password'} ref={passwordRef} />
          </div>
          <button className='w-full bg-orange-400 p-2 font-semibold text-white rounded-xl'>Login</button>
        </form>
